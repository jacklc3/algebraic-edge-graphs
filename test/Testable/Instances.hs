...
instance TestableGraph (AdjacencyMap Int) where
    isEmpty     = AM.isEmpty
    hasEdge     = AM.hasEdge
...
instance TestableGraph IntAdjacencyMap where
    isEmpty     = IAM.isEmpty
    hasEdge     = IAM.hasEdge
...
instance TestableAdjacencyGraph (AdjacencyMap Int) where
...
instance TestableAdjacencyGraph IntAdjacencyMap where
